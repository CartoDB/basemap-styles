...
@continent_text:     #8a99a4; 
@continent_halo:     #fafaf8; 

@country_text_dark:  #8a99a4; 
@country_text_med:   #abb6be; 
@country_text_light: #abb6be; 
@country_halo:       #fafaf8; 

@state_text:         #97a4ae; 
@state_text_light:   #abb6be; 
@state_halo:         #fafaf8; 

@place_text:         #8f9daa;
@place_halo:         rgba(250,250,250,0.8);


//city shield
@city_shield:   url(images/positron-label-under.png);
...
//Road labels
@road_text_med:       #afbac2;
@road_text_light:     #afbac2; 
@road_text:           #afbac2;
@motorway_halo:       rgba(247, 247, 247, 0.5);
@primary_halo:        rgba(247, 247, 247, 0.5);
@minor_halo:          rgba(247, 247, 247, 0.5);
@tunnel_halo:         rgba(247, 247, 247, 0.5);
//@text_transform:      uppercase;

//poi
@poi_light:           #88a48e;
@poi_dark:            #88a48e;
@poi_halo:            rgba(247, 247, 247, 0.5);
